...
import 'line.dart';
import 'song_provider4.dart';
import 'package:path_provider/path_provider.dart';



class Game6 extends StatefulWidget {
  static String id='game6';
  @override
  _Game6State createState() => _Game6State();
}

class _Game6State extends State<Game6> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  void _showFinishDialog1() {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text("Congratulations! Just one more hurdle:) The 4th clue is 'p'. Don't forget to write it down somewhere",
            style: TextStyle(
              fontFamily: 'Montserrat',
            ),),
          actions: <Widget>[
