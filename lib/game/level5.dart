...
import 'line.dart';
import 'song_provider5.dart';
import 'package:path_provider/path_provider.dart';



class Game7 extends StatefulWidget {
  static String id='game7';
  @override
  _Game7State createState() => _Game7State();
}

class _Game7State extends State<Game7> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  void _showFinishDialog1() {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text("Congratulations! Now you have mastered it :)  The 5th clue is 'Ee'. Write it down and get the answer. Now hurry! DM us the answer",
            style: TextStyle(
              fontFamily: 'Montserrat',
            ),),
          actions: <Widget>[
