...
import 'line.dart';
import 'song_provider1.dart';
import 'package:path_provider/path_provider.dart';



class Game3 extends StatefulWidget {
  static String id='game3';
  @override
  _Game3State createState() => _Game3State();
}

class _Game3State extends State<Game3> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  void _showFinishDialog1() {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text("Congratulations! Expect more tiles in level 2 :) The 1st clue is 'H'. Don't forget to write it down somewhere"
            ,
            style: TextStyle(
              fontFamily: 'Montserrat',
            ),),
