...
import 'line.dart';
import 'song_provider3.dart';
import 'package:path_provider/path_provider.dart';



class Game5 extends StatefulWidget {
  static String id='game5';
  @override
  _Game5State createState() => _Game5State();
}

class _Game5State extends State<Game5> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  void _showFinishDialog1() {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text("Congratulations! Expect more tiles in level 4 :) The 3rd clue is 'p'. Don't forget to write it down somewhere",
            style: TextStyle(
              fontFamily: 'Montserrat',
            ),),
          actions: <Widget>[
