...
class Getaberaya extends StatefulWidget {
  static String id='getaberaya';
  @override
  _GetaberayaState createState() => _GetaberayaState();
}

class _GetaberayaState extends State<Getaberaya> {
